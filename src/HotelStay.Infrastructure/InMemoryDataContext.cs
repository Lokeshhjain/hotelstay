...
public sealed class InMemoryDataContext
{
    public InMemoryDataContext()
    {
        ...
        {
            new("premier-1", "PremierStays", "standard", 120m, CancellationPolicy.FreeCancellation, true),
            new("premier-2", "PremierStays", "deluxe", 180m, CancellationPolicy.NonRefundable, true)
        };

        BudgetNestsOffers = new List<ProviderHotelOffer>
        {
            new("budget-1", "BudgetNests", "standard", 90m, CancellationPolicy.NonRefundable, false),
            new("budget-2", "BudgetNests", "suite", 220m, CancellationPolicy.Flexible, true)
        };
